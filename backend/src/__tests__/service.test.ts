...
import { httpClientFactoryMock, loggerFactoryMock, mockBlockDetails, mockDataFeed } from "./mocks";
...
describe("Blockchain service", () => {
  ...
  const loggerMock = loggerFactoryMock();
  ...
  const blockchainDataSource = blockchainDataSourceFactory(httpClientMock, loggerMock, config);
